...
# Set all versions
RAZOR_VERSION := RAZOR-M-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(RAZOR_BUILD_TYPE)$(RAZOR_POSTFIX)
RAZOR_MOD_VERSION := RAZOR-M-$(RAZOR_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(RAZOR_BUILD_TYPE)$(RAZOR_POSTFIX)
