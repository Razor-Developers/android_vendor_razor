...
# Set all versions
RAZOR_VERSION := TEAM-RAZOR-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(RAZOR_BUILD_TYPE)$(RAZOR_POSTFIX)
RAZOR_MOD_VERSION := TEAM-RAZOR-$(RAZOR_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(RAZOR_BUILD_TYPE)$(RAZOR_POSTFIX)

PRODUCT_PROPERTY_OVERRIDES += \
    BUILD_DISPLAY_ID=$(BUILD_ID) \
    razor.ota.version=$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR) \
